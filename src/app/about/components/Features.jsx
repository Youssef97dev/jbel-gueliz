...
const Features = () => {
  return (
    <div className="w-full h-full flex flex-col justify-between items-center lg:px-44 px-8 py-12 bg-[#e0ddd8]">
      <h1 className="font-medium text-4xl lg:text-5xl text-center text-background">{`Les valeurs de notre entreprise`}</h1>
      <div className="w-full flex flex-col lg:flex-row justify-between items-start gap-10 lg:gap-40 mt-8 text-center">
